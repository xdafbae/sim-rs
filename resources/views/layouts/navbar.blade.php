<header class="navbar navbar-expand-md d-print-none">
    <div class="container navbar-container">
        ...
        <div class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <img src="{{ asset('templates/templates/dist/img/logo_rsud.png') }}" style="width: 42px; height: 42px; object-fit: contain;" alt="Logo SIM-RS">
            SIM-RS
        </div><!-- END NAVBAR LOGO -->
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            @if (session('warning_profile'))
            <script>
                Swal.fire({
                    toast: true,
                    position: 'bottom-end',
                    icon: 'warning',
                    title: 'Tidak ada perubahan data profile!',
                    showConfirmButton: false,
                    timer: 3000,
                    timerProgressBar: true,
                });
